 ...
 *  ex) nextInt() 에 대하여 정수를 입력하지 않고 다른 자료형(문자 등) 을 입력한경우
 */
public class InputMismatch {
	public static void main(String[] args) {
		...
		do {
			...
			// 예외 메세시		: java.utill.InputMismatchException
			...
			case 5: menuName = "Spting Framework"; break;
			case 6: menuName = "React"; break;
			case 7: menuName = "Fluuter"; break;
			}

...
public class ZonedDateTimeEx {
	...
	public static void main(String[] args) {
		...
		ZonedDateTime newYorklDateTime = ZonedDateTime.now( ZoneId.of("America/New_York"));
		System.out.println("뉴옥 표준시 : " + newYorklDateTime);
		
		ZonedDateTime japanlDateTime = ZonedDateTime.now( ZoneId.of("Japan"));
		System.out.println("일본 표준시 : " + japanlDateTime);
		...
		// 윤년?
		// 1년: 365.25일이라서, 0.25x4=1일을 매년 4년마다 추가해서 사용
